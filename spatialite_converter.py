...
class Converter:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Spatialite_Converter')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/spatialite_converter/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Spatialite convert'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginDatabaseMenu(
                self.tr(u'&Spatialite_Converter'),
                action)
